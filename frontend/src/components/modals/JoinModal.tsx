...
export default function JoinModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/20 backdrop-blur-sm p-4 animate-fade-in">
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-[420px] overflow-hidden border border-slate-100 relative flex flex-col items-center">
                {/* Gradient overlay */}
                <div className="absolute top-0 w-full h-32 bg-gradient-to-b from-[#13a4ec]/5 to-transparent pointer-events-none" />
                ...
                <div className="pt-10 pb-8 px-8 w-full flex flex-col items-center relative z-10">
                    ...
                    <div className="text-center mb-6">
                        <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Join Conversation</h2>
                        <p className="text-slate-500 text-sm mt-1">Customize how you appear to others</p>
                    </div>
                    ...
                    >
                        <div className="w-32 h-32 rounded-full border-[6px] border-slate-50 shadow-xl bg-gradient-to-br from-[#13a4ec] to-cyan-400 flex items-center justify-center overflow-hidden relative">
                            {selectedAvatar?.url ? (
                                <div
                        ...
                        <button className="absolute bottom-1 right-1 bg-[#13a4ec] text-white rounded-full p-2.5 shadow-md border-4 border-white hover:bg-sky-500 transition-colors group-hover:scale-110">
                    ...
                    <div className="w-full space-y-5">
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group focus-within:text-[#13a4ec]">
                                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-[#13a4ec] transition-colors">
                                ...
                                <input
                                    ...
                                    maxLength={20}
                                    className="w-full bg-slate-50 border border-slate-200 rounded-xl py-3.5 pl-12 pr-4 text-slate-800 font-semibold focus:outline-none focus:ring-2 focus:ring-[#13a4ec]/20 focus:border-[#13a4ec] transition-all placeholder:text-slate-400 shadow-sm"
                                />
                            </div>
                            {error && (
